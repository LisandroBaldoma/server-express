...
sessionsRouter.get("/github/callback", antenticacionPorGithub_CB, (req, res, next) => {res.redirect("/");});
...
sessionsRouter.get("/current", soloLogueadosApi, getCurrentSessionController); //POST http://localhost:8080/api/current
